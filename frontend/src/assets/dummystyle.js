export const landingPageStyles = {
  container: "min-h-screen bg-gradient-to-br from-[#e0f7ff] via-white to-[#dbeafe]",

  header: "fixed top-0 w-full z-50 bg-white/70 backdrop-blur-xl border-b border-sky-100/50",
  ...
  logoIcon: "w-10 h-10 bg-gradient-to-br from-sky-600 to-cyan-600 rounded-2xl flex items-center justify-center shadow-lg shadow-sky-200",
  logoIconInner: "w-5 h-5 text-white",
  logoText: "text-xl sm:text-2xl font-black bg-gradient-to-r from-sky-600 to-cyan-600 bg-clip-text text-transparent",
  mobileMenuButton: "md:hidden p-2 rounded-xl hover:bg-sky-50 transition-colors",
  mobileMenuIcon: "text-sky-600",

  desktopAuthButton: "relative group px-6 sm:px-8 py-2 sm:py-3 bg-gradient-to-r from-sky-600 to-cyan-600 text-white font-bold rounded-2xl overflow-hidden transition-all hover:scale-105 hover:shadow-xl hover:shadow-sky-200",
  desktopAuthButtonText: "relative",
  desktopAuthButtonOverlay: "absolute inset-0 bg-gradient-to-r from-cyan-600 to-sky-600 opacity-0 group-hover:opacity-100 transition-opacity",
  mobileAuthButton: "w-full px-6 py-3 bg-gradient-to-r from-sky-600 to-cyan-600 text-white font-bold rounded-2xl",

  mobileMenu: "md:hidden bg-white/95 backdrop-blur-lg w-full fixed top-16 left-0 right-0 z-40 shadow-lg border-b border-sky-100/50 transition-all duration-300 ease-in-out",
  mobileMenuContainer: "max-w-6xl mx-auto px-4 sm:px-6 py-4 flex flex-col gap-4",
  mobileUserInfo: "flex flex-col gap-4 py-2",
  mobileUserWelcome: "text-sky-700 font-medium text-center py-2 text-base sm:text-lg",
  mobileDashboardButton: "w-full px-6 py-3 bg-gradient-to-r from-sky-600 to-cyan-600 text-white font-bold rounded-xl hover:shadow-lg hover:shadow-sky-200/50 transition-all",
  mobileAuthButton: "w-full px-6 py-3 bg-gradient-to-r from-sky-600 to-cyan-600 text-white font-bold rounded-xl hover:shadow-lg hover:shadow-sky-200/50 transition-all",

  main: "pt-24",

  heroSection: "max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-20",
  heroGrid: "flex flex-col md:flex-row items-center justify-between gap-10 lg:gap-12",
  heroLeft: "w-full md:w-1/2 space-y-8",
  tagline: "inline-flex items-center gap-2 sm:gap-3 px-4 py-2 bg-gradient-to-r from-sky-100 to-cyan-100 border border-sky-200 text-sky-700 rounded-full font-bold text-xs sm:text-sm",
  heading: "text-4xl sm:text-6xl lg:text-8xl font-black leading-tight",
  headingText: "block text-slate-900",
  headingGradient: "block bg-gradient-to-r from-sky-600 via-cyan-600 to-blue-500 bg-clip-text text-transparent",
  ...
  primaryButton: "group relative px-10 py-4 bg-gradient-to-r from-sky-600 to-cyan-600 text-white font-bold rounded-2xl overflow-hidden transition-all hover:scale-105 hover:shadow-2xl hover:shadow-sky-200",
  primaryButtonOverlay: "absolute inset-0 bg-gradient-to-r from-cyan-600 to-blue-500 opacity-0 group-hover:opacity-100 transition-opacity",
  ...
  secondaryButton: "px-8 sm:px-10 py-3 sm:py-4 border-2 border-sky-200 text-sky-700 font-bold rounded-2xl hover:border-sky-300 hover:bg-sky-50 transition-all",

  statsContainer: "flex flex-wrap sm:flex-nowrap items-center gap-6 sm:gap-8 pt-6",
  statItem: "text-center",
  statNumber: "text-2xl sm:text-3xl lg:text-4xl font-black bg-gradient-to-r from-sky-500 to-blue-600 bg-clip-text text-transparent",
  ...
  heroIllustrationBg: "absolute -inset-8 bg-gradient-to-r from-sky-200/50 to-cyan-200/50 rounded-3xl blur-3xl",
  ...
  svgRectPrimary: "fill-[#0284c7]",
  svgRectSecondary: "fill-[#22d3ee]",
  svgRectLight: "fill-[#e0f2fe]",
  svgRectSkill: "fill-[#bae6fd]",
  svgAnimatedCircle: "fill-[#06b6d4] opacity-80",
  svgAnimatedRect: "fill-[#0ea5e9] opacity-80",
  svgAnimatedPolygon: "fill-[#0f766e] opacity-80",

  featuresSection: "bg-gradient-to-br from-sky-50 to-cyan-50 py-16 sm:py-24",
  ...
  featuresTitleGradient: "bg-gradient-to-r from-sky-600 to-cyan-600 bg-clip-text text-transparent",
  ...
  featureCardHover: "absolute -inset-2 bg-gradient-to-r opacity-0 group-hover:opacity-100 transition-opacity blur-xl rounded-3xl from-sky-200 to-cyan-200",
  ...
  featureCardViolet: "from-sky-50 to-blue-50",
  featureCardFuchsia: "from-cyan-50 to-sky-100",
  featureCardOrange: "from-sky-100 to-blue-100",
  featureIconViolet: "from-sky-500 to-blue-600",
  featureIconFuchsia: "from-cyan-500 to-sky-600",
  featureIconOrange: "from-sky-400 to-cyan-500",

  ctaSection: "py-16 sm:py-24",
  ctaContainer: "max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center",
  ctaCard: "relative",
  ctaCardBg: "absolute -inset-6 sm:-inset-8 bg-gradient-to-r from-sky-200/50 to-cyan-200/50 rounded-3xl blur-3xl",
  ctaCardContent: "relative bg-gradient-to-br from-white to-sky-50 border border-sky-100 rounded-3xl p-8 sm:p-16",
  ctaTitle: "text-3xl sm:text-4xl lg:text-5xl font-black text-slate-900 mb-4 sm:mb-6",
  ctaTitleGradient: "bg-gradient-to-r from-sky-600 to-cyan-600 bg-clip-text text-transparent",
  ctaDescription: "text-base sm:text-lg text-slate-600 mb-6 sm:mb-10 max-w-2xl mx-auto font-medium",
  ctaButton: "group relative px-8 sm:px-12 py-3 sm:py-5 bg-gradient-to-r from-sky-600 to-cyan-600 text-white font-black text-lg rounded-2xl overflow-hidden transition-all hover:scale-105 hover:shadow-2xl hover:shadow-sky-200",
  ctaButtonOverlay: "absolute inset-0 bg-gradient-to-r from-cyan-600 to-blue-500 opacity-0 group-hover:opacity-100 transition-opacity",
  ctaButtonText: "relative",

  footer: "border-t border-sky-100 bg-gradient-to-r from-sky-50 to-cyan-50 py-6 sm:py-8",
  ...
  footerHeart: "bg-gradient-to-r from-blue-500 to-sky-500 bg-clip-text text-transparent",
  footerLink: "hover:text-sky-400 underline"
};
...
export const dashboardStyles = {
  ...
  headerSubtitle: "text-sky-600",

  // Create Button
  createButton: "group relative px-10 py-4 bg-gradient-to-r from-sky-600 to-cyan-600 text-white font-bold rounded-2xl overflow-hidden transition-all hover:scale-105 hover:shadow-2xl hover:shadow-sky-200",
  createButtonOverlay: "absolute inset-0 bg-gradient-to-r from-cyan-600 to-blue-500 opacity-0 group-hover:opacity-100 transition-opacity",
  createButtonContent: "relative flex items-center gap-3",

  // Loading
  spinnerWrapper: "flex justify-center items-center py-12",
  spinner: "animate-spin rounded-full h-12 w-12 border-t-2 border-b-2 border-sky-600",

  // Empty State
  emptyStateWrapper: "flex flex-col items-center justify-center py-12 text-center",
  emptyIconWrapper: "bg-sky-100 p-4 rounded-full mb-4",
  emptyTitle: "text-xl font-bold text-blue-900 mb-2",
  emptyText: "text-sky-600 max-w-md mb-6",

  // Grid
  grid: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6",

  // New Resume Card
  newResumeCard: "flex flex-col items-center justify-center bg-gradient-to-br from-sky-50 to-cyan-50 border-2 border-dashed border-sky-300 rounded-2xl p-6 cursor-pointer transition-all hover:shadow-lg hover:border-sky-500 h-full",
  newResumeIcon: "w-16 h-16 rounded-full bg-gradient-to-r from-sky-600 to-cyan-600 flex items-center justify-center mb-4",
  newResumeTitle: "text-xl font-bold text-blue-900 mb-2 text-center",
  newResumeText: "text-sky-600 text-center",

  // Modal
  modalHeader: "flex justify-between items-center mb-4",
  modalTitle: "text-xl font-bold text-blue-900",
  modalCloseButton: "text-sky-500 hover:text-sky-700",

  // Delete Confirmation
  deleteIconWrapper: "bg-red-100 p-3 rounded-full mb-4",
  deleteTitle: "text-lg font-bold text-blue-900 mb-2",
  deleteText: "text-sky-600 mb-4",
};
...
export const cardStyles = {
  ...
  cardBackground: "absolute inset-0 bg-gradient-to-br from-sky-100 via-transparent to-cyan-100 opacity-0 group-hover:opacity-100 transition-opacity duration-500",
  ...
  emptyPreviewText: "text-blue-900 text-sm font-bold",
  emptyPreviewSubtext: "text-slate-500 text-xs mt-1",
  infoArea: "bg-sky-50 border-t border-sky-100 p-4 sm:p-6",
  title: "text-sm sm:text-base font-bold text-blue-900 truncate mb-2 group-hover:text-sky-600 transition-colors",
  ...
  editButton: "group/btn w-12 h-12 flex items-center justify-center bg-gradient-to-r from-sky-600 to-cyan-600 rounded-2xl shadow-md hover:scale-110 transition-all duration-300",
  deleteButton: "group/btn w-12 h-12 flex items-center justify-center bg-gradient-to-r from-blue-400 to-blue-600 rounded-2xl shadow-md hover:scale-110 transition-all duration-300",
  ...
  completionIndicator: "absolute top-4 right-4 z-10 flex items-center gap-2 px-3 py-2 bg-sky-50 border border-sky-100 rounded-full shadow-sm",
  completionDot: "w-3 h-3 rounded-full flex items-center justify-center",
  completionDotInner: "w-1 h-1 bg-white rounded-full",
  completionPercentageText: "text-xs font-bold text-blue-900",

  // Completion color classes
  completionHigh: "from-emerald-500 to-green-600",
  completionMedium: "from-yellow-400 to-orange-400",
  completionLow: "from-sky-400 to-blue-600",

  // TemplateCard styles
  templateCard: "relative rounded-lg overflow-hidden shadow-md transition-all duration-300 cursor-pointer border border-sky-100",
  templateCardSelected: "ring-2 ring-sky-500 scale-[1.02]",
  templateCardDefault: "hover:shadow-lg hover:border-sky-200",
  ...
  selectionCircle: "w-8 h-8 bg-sky-600 rounded-full flex items-center justify-center shadow-md",
  ...
  templateName: "text-sm font-medium text-blue-900",
...
export const authStyles = {
  container: "w-[90vw] md:w-[400px] p-8 bg-gradient-to-br from-white to-sky-50 rounded-3xl border border-sky-100 shadow-2xl",
  headerWrapper: "text-center mb-8",
  title: "text-2xl font-black text-blue-900 mb-2",
  ...
  submitButton: "w-full py-4 bg-gradient-to-r from-sky-600 to-cyan-600 text-white font-black rounded-2xl hover:scale-105 hover:shadow-xl hover:shadow-sky-200 transition-all text-lg",
  switchText: "text-center text-sm text-slate-600 font-medium",
  switchButton: "font-black text-sky-600 hover:text-cyan-600 transition-colors",
  ...
  signupTitle: "text-2xl font-black text-blue-900 mb-2",
  signupSubtitle: "text-slate-600 font-medium",
  signupForm: "space-y-4",
  signupSubmit: "w-full py-4 bg-gradient-to-r from-sky-500 to-cyan-600 text-white font-black rounded-2xl hover:scale-105 hover:shadow-xl hover:shadow-sky-200 transition-all text-lg",
  signupSwitchButton: "font-black text-sky-600 hover:text-cyan-600 transition-colors"
};
...
export const shimmerStyle = `
  ...
  .animate-shimmer {
    ...
    background: linear-gradient(to right, #e0f2fe 4%, #bae6fd 25%, #e0f2fe 36%);
...
export const commonStyles = {
  trashButton: "absolute top-4 right-4 p-2 text-red-600 hover:bg-red-100 rounded-xl transition-all",
  addButtonBase: "flex items-center gap-3 px-6 py-3 text-white font-extrabold rounded-xl hover:scale-105 transition-all shadow-lg bg-gradient-to-r from-indigo-500 to-purple-500",
};

// AdditionalInfoForm Styles
export const additionalInfoStyles = {
  container: "p-8 bg-gradient-to-br from-white to-indigo-50",
  heading: "text-2xl font-extrabold text-slate-900 mb-8",
  sectionHeading: "text-lg font-bold text-slate-800 mb-6 flex items-center gap-2",
  dotViolet: "w-2 h-2 bg-gradient-to-r from-indigo-500 to-purple-500 rounded-full",
  dotOrange: "w-2 h-2 bg-gradient-to-r from-yellow-500 to-pink-500 rounded-full",
  languageItem: "relative bg-white border border-indigo-100 p-6 rounded-2xl shadow-md hover:shadow-xl transition-all",
  interestItem: "relative",
  addButtonLanguage: "bg-gradient-to-r from-indigo-500 to-purple-500",
  addButtonInterest: "bg-gradient-to-r from-yellow-500 to-pink-500",
};
...
export const certificationInfoStyles = {
  ...
  heading: "text-2xl font-extrabold text-slate-900 mb-8",
  item: "relative bg-white border border-emerald-100 p-6 rounded-2xl shadow-md hover:shadow-xl transition-all",
...
export const educationDetailsStyles = {
  ...
  heading: "text-2xl font-extrabold text-slate-900 mb-8",
  item: "relative bg-white border border-blue-100 p-6 rounded-2xl shadow-md hover:shadow-xl transition-all",
