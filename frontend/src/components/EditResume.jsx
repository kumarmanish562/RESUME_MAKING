...
const EditResume = () => {
  ...
  // TAke back to previous form stte or take back to dashboard if on profile-info
  const goBack = () => {
    const pages = [
      "profile-info",
      "contact-info",
  ...
  // aading new items IE Infromation
...
// This function will help in choosing the preview as well as helps in downloading the resume also saves the resume as a images
  ...
  // this function will help in upadting the rtesumes. and put will help in upadtion  on backend
  ...
  //Delete resume function to delete 
      ...
      <div className={containerStyles.main}>
        <div className={containerStyles.header}>
          ...
          <div className='flex flex-wrap items-center gap-3'>
            ...
            <button className={buttonStyles.delete} onClick={handleDeleteResume} disabled={isLoading}>
              <Trash2 size={16} />
              <span className='text-sm'>
                Delete
              </span>
